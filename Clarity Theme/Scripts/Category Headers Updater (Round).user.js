...
templateCss = `[data-query*='"status":7']:not([data-query*='order']):not([data-query*='tag"']):not([data-query*='"s"']) .list-item:nth-child($index){margin-top:162px;}[data-query*='"status":7']:not([data-query*='order']):not([data-query*='tag\"']):not([data-query*='"s"']) .list-item:nth-child($index) .status:before{content:'$content'}`;
